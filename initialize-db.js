...
db.run("CREATE TABLE IF NOT EXISTS feedbacks (survey_question text, card_number text, rated_score int, rated_name text, location_code text, location_name text, date_created integer )" );
db.close();
